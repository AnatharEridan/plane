...
export default {
  ...
  bug_tracking: {
    location: {
      label: "Где найдена ошибка",
      placeholder: "Выберите место",
      no_options: "Настройте варианты в настройках проекта.",
    },
    version: {
      label: "Версия",
      placeholder: "Укажите версию",
    },
    settings: {
      title: "Отслеживание ошибок",
      description: "Настройте свойства задач, которые команда использует при регистрации ошибок.",
      locations: {
        title: "Где может быть найдена ошибка",
        description: "Эти варианты появятся в выпадающем списке «Где найдена ошибка» у каждой задачи.",
        add: "Добавить вариант",
        empty: "Варианты пока не настроены.",
        placeholder: "Например: Web, iOS, Android",
      },
      validation: {
        empty: "Название варианта не может быть пустым.",
        duplicate: "Названия вариантов не должны повторяться.",
      },
      toast: {
        success: "Настройки отслеживания ошибок обновлены.",
        error: "Не удалось обновить настройки. Попробуйте ещё раз.",
      },
    },
  },
  project_settings: {
